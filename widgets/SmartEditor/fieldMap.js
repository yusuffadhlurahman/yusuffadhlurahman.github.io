      ...
      _addSourceLayerFieldOptions: function (targetField, sourceLayer) {
        ...
        array.forEach(sourceLayer.fields, lang.hitch(this, function (currentField) {
          ...
          if (currentField.type !== "esriFieldTypeGeometry" &&
            ...
            if (!hasDefault && targetField.name.toLowerCase() === currentField.name.toLowerCase() ||
              (targetField.alias && currentField.alias &&
                targetField.alias.toLowerCase() === currentField.alias.toLowerCase()) ||
              (targetField.alias &&
                targetField.alias.toLowerCase() === currentField.name.toLowerCase()) ||
              (currentField.alias &&
                targetField.name.toLowerCase() === currentField.alias.toLowerCase())) {
              hasDefault = true;
              options.push({
